...
with open("course_list.txt", "r", encoding="utf-8") as course_file:
        c = course_file.read().split("\n")
with open("student_course_list.txt", "r", encoding="utf-8") as s_course_file:
    ...
    if state == 2:
        ...
        if final>=7:
            ...
            if deleteself=="1":
                ...
                with fileinput.FileInput("student_course_list.txt", inplace=True, backup=".bak") as file:
                   for line in file:
